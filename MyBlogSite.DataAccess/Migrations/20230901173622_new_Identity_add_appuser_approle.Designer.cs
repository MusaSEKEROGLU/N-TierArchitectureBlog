...
namespace MyBlogSite.DataAccess.Migrations
{
    ...
    [Migration("20230901173622_new_Identity_add_appuser_approle")]
    partial class new_Identity_add_appuser_approle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.Admin", b =>
                {
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.BlogRayting", b =>
                {
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.Message", b =>
                {
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.Message2", b =>
                {
                    b.Property<int>("MessageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.Notification", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("MyBlogSite.Entities.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MyBlogSite.Entities.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyBlogSite.Entities.Concrete.Message2", b =>
                {
                    b.HasOne("MyBlogSite.Entities.Concrete.Writer", "ReceiverUser")
                        .WithMany("WriterReceiver")
                        .HasForeignKey("ReceiverID");

                    b.HasOne("MyBlogSite.Entities.Concrete.Writer", "SenderUser")
