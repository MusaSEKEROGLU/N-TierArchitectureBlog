...
namespace MyBlogSite
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // x.Password.RequireUppercase = false; þifrede büyük harf olmasýn
            ...
            //ilk baþta login sayfasý açýlýr ve diðer linkler pasif halde olur
            services.AddMvc();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStatusCodePagesWithReExecute("/ErrorPage/Error1", "?code={0}");//hata kodlarý için eklendi,yalnýþ adrese gidilmesi sonucunda hata sayfasýna yönlendirilecek
